...
version="1.1.0"
input_raster_dir="/opt/soilmapnik/v1.1_data/output/raw_rasters"
input_model_dir="/opt/soilmapnik/v1.1_data/output/semivariogram/model"
input_rmse_dir="/opt/soilmapnik/v1.1_data/output/kriging_cross_validation"
#output_netcdf_dir="/opt/soilmapnik/v1.1_data/output/netcdf/monthly"
output_netcdf_dir="/opt/soilmapnik/output/netcdf/v${version}/monthly"
...
source ${venv}
ncfile="vwc_v${version}_${month}.nc"
